...
// func (u *GroupUsecase) CreateGroup(token, name string, permissions map[string]bool) (int, error) {
...
// 	}
// 	if role != "admin" {
// 		return 0, errors.New("only admins can create groups")
// 	}
...
// 		Name:       name,
// 		CreatedBy:  adminID,
// 		Permission: permissions, // Assuming domain.Group uses Permissions
// 		CreatedAt:  time.Now(),
// 	}
