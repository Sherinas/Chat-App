...
// 	websocket.RegisterWebSocketRoute(mux, *chatUsecase, redisService, *userUsecase)
...
func main() {
	...
	// Add serveFile handler
	r.GET("/uploads/*filepath", serveFile)
...
// serveFile function to serve uploaded files
